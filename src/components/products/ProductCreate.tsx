...
interface ProductForm {
    ...
    // Campos adicionales para manejo de stock/precios
    precio: number;
    stock: number;
    stockMinimo: number;
...
export const ProductCreate: React.FC<ProductCreateProps> = ({
    ...
    // Mock data para subclases y unidades de medida
    ...
    const onSubmit = async (data: ProductForm) => {
        ...
        try {
            ...
            const newItem: Item = {
                itemID: Date.now(), // En producción vendría de la BD
                        ...
                        <Grid size={{ xs: 12 }}>
                            <Alert severity="info" sx={{ mt: 2 }}>
                                <Typography variant="body2">
                                    <strong>Nota:</strong> Las fechas de creación y modificación se generarán automáticamente.
                                    El item estará disponible inmediatamente en el sistema tras su creación.
                                </Typography>
                            </Alert>
                        </Grid>
                    </Grid>
